...
export function BackHeader(props: SvgProps) {
	return (
		<Svg width={10} height={18} fill={'none'} {...props}>
			<Path
				d={
					'M9.596 15.726c.235.257.365.596.352.948 0 .352-.13.676-.378.934-.235.243-.56.392-.9.392-.339 0-.665-.122-.912-.365l-7.38-7.66a1.343 1.343 0 01-.274-.434A1.391 1.391 0 010 9.027c0-.176.04-.352.104-.528.065-.162.157-.311.274-.433l7.38-7.66c.117-.122.26-.23.417-.298.17-.067.339-.108.508-.108.17 0 .352.027.509.095.156.067.3.176.43.297.117.122.209.285.274.447.078.163.104.338.104.528 0 .176-.04.352-.104.514-.065.163-.17.311-.3.447l-6.454 6.7 1.226 1.258 5.228 5.44z'
				}
				fill={'#C89524'}
			/>
		</Svg>
...
export function IconListOrders({color, ...props}: SvgProps) {
	return (
		<Svg width={21} height={25} fill={'none'} {...props}>
			<Path
				d={
					'M8 8.584a.5.5 0 01.5-.5h7a.5.5 0 010 1h-7a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h7a.5.5 0 110 1h-7a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h7a.5.5 0 110 1h-7a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h7a.5.5 0 110 1h-7a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h7a.5.5 0 110 1h-7a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h7a.5.5 0 110 1h-7a.5.5 0 01-.5-.5zM6 8.667a.583.583 0 111.167 0 .583.583 0 01-1.167 0zm0 2a.583.583 0 111.167 0 .583.583 0 01-1.167 0zm0 2a.583.583 0 111.167 0 .583.583 0 01-1.167 0zm0 2a.583.583 0 111.167 0 .583.583 0 01-1.167 0zm0 2a.583.583 0 111.167 0 .583.583 0 01-1.167 0zm0 2a.583.583 0 111.167 0 .583.583 0 01-1.167 0z'
				}
				fill={color}
			/>
			<Path
				d={
					'M17.583 4H3.417c-.376 0-.736.125-1.002.348a1.1 1.1 0 00-.415.84v16.625c0 .314.15.617.415.84A1.57 1.57 0 003.417 23h14.166c.376 0 .736-.125 1.002-.348a1.1 1.1 0 00.415-.84V5.188a1.1 1.1 0 00-.415-.84A1.566 1.566 0 0017.583 4zM17 21H4V6h13v15z'
				}
				fill={color}
			/>
		</Svg>
...
export const IconSetting = (props: SvgProps) => (
	<Svg width={43} height={43} fill={'none'} {...props}>
		...
		<G clipPath={'url(#a)'}>
			<Path
				d={
					'M33.022 24.63l-1.802-1.458a8.873 8.873 0 000-3.01l1.802-1.458a.83.83 0 00.279-.42.792.792 0 00-.023-.497l-.025-.067a11.423 11.423 0 00-2.192-3.591l-.05-.055a.892.892 0 00-.442-.266.932.932 0 00-.523.018l-2.236.753a9.837 9.837 0 00-2.743-1.5l-.431-2.213a.822.822 0 00-.245-.44.9.9 0 00-.465-.23l-.074-.012a13.114 13.114 0 00-4.374 0l-.074.013a.9.9 0 00-.465.23.822.822 0 00-.245.439l-.434 2.224a9.822 9.822 0 00-2.723 1.494l-2.253-.758a.927.927 0 00-.523-.018.888.888 0 00-.442.266l-.05.055a11.48 11.48 0 00-2.192 3.59l-.025.068a.808.808 0 00.256.917l1.824 1.474c-.086.49-.127.99-.127 1.486 0 .5.041 1 .127 1.487l-1.824 1.474a.83.83 0 00-.279.42.792.792 0 00.023.497l.025.067a11.453 11.453 0 002.192 3.591l.05.055a.89.89 0 00.442.266.932.932 0 00.523-.018l2.253-.758a9.754 9.754 0 002.723 1.494l.434 2.224c.033.167.118.32.245.44a.9.9 0 00.465.23l.074.012c1.446.246 2.927.246 4.374 0l.074-.013a.9.9 0 00.465-.23.821.821 0 00.245-.439l.431-2.213a9.77 9.77 0 002.743-1.5l2.236.753a.927.927 0 00.523.018.888.888 0 00.442-.266l.05-.055a11.482 11.482 0 002.192-3.59l.025-.068a.802.802 0 00-.256-.912zm-3.755-4.16a6.992 6.992 0 010 2.4l-.181 1.044 2.055 1.664a9.526 9.526 0 01-1.172 1.917l-2.553-.857-.863.672a7.8 7.8 0 01-2.181 1.193l-1.048.372-.493 2.526c-.777.083-1.56.083-2.338 0l-.492-2.531-1.04-.378a7.806 7.806 0 01-2.164-1.19l-.864-.674-2.57.864a9.723 9.723 0 01-1.17-1.916l2.076-1.68-.179-1.041a7.109 7.109 0 01-.102-1.185c0-.399.033-.797.102-1.185l.179-1.042-2.077-1.68a9.52 9.52 0 011.172-1.916l2.569.865.864-.675a7.806 7.806 0 012.164-1.19l1.043-.372.492-2.531a10.955 10.955 0 012.338 0l.492 2.526 1.048.372c.79.281 1.524.682 2.181 1.193l.864.671 2.553-.856a9.72 9.72 0 011.171 1.916L29.09 19.43l.178 1.04zm-7.6-3.644c-2.673 0-4.84 2.052-4.84 4.583s2.167 4.583 4.84 4.583c2.674 0 4.842-2.052 4.842-4.583 0-2.53-2.168-4.583-4.841-4.583zm2.18 6.646a3.086 3.086 0 01-1 .633 3.22 3.22 0 01-1.18.22 3.16 3.16 0 01-2.178-.853 2.903 2.903 0 01-.668-.946 2.772 2.772 0 01-.234-1.117c0-.778.322-1.51.902-2.062a3.147 3.147 0 012.179-.854c.822 0 1.595.302 2.178.854.287.27.514.592.669.946.155.354.234.733.233 1.116a2.83 2.83 0 01-.902 2.063z'
				}
				fill={'#C89524'}
			/>
		</G>
		<Defs>
			<ClipPath id={'a'}>
				<Path fill={'#fff'} transform={'translate(8 5)'} d={'M0 0h28v28H0z'} />
			</ClipPath>
		</Defs>
	</Svg>
);
